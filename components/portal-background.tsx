...
function project(tile: Tile, cellSize: number, px: number, py: number) {
  ...
  return {
    x: tile.x + cellSize * 0.03 + px * size,
    y: tile.y + cellSize * 0.03 + py * size,
  }
}
...
export function PortalBackground() {
  ...
  return (
    <div className="portal-background" aria-hidden="true">
      <canvas ref={canvasRef} className="portal-background__canvas" />
      <div className="portal-background__veil" />
    </div>
  )
}
